...
from dinov2_tan.attention import Attention, MemEffAttention


sys.path.append("/home/students/tnguyen/masterthesis")

from dinov2_lib.dinov2.layers.drop_path import DropPath
from dinov2_lib.dinov2.layers.layer_scale import LayerScale
from dinov2_lib.dinov2.layers.mlp import Mlp
...
class NestedTensorBlock(Block):
    ...
    def forward(self, x_or_x_list, return_attention: bool=False):
